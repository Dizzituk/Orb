...
**Version:** 0.12.8 (Architecture Map v22)  
...
12. [Phase 4: Job Engine & Artefacts](#phase-4-job-engine--artefacts)  
13. [Provider Registry](#provider-registry)  
14. [DateTime Context](#datetime-context)  
15. [Streaming Responses](#streaming-responses)  
16. [Reasoning Panel](#reasoning-panel)  
17. [Markdown Rendering](#markdown-rendering)  
18. [Web Search](#web-search)  
19. [Chat History](#chat-history)  
20. [File Ingestion Pipeline](#file-ingestion-pipeline)  
21. [Image Analysis Pipeline](#image-analysis-pipeline)  
22. [Video Analysis Pipeline](#video-analysis-pipeline)  
23. [Semantic Search System](#semantic-search-system)  
24. [Error Taxonomy](#error-taxonomy)  
25. [Quick Start](#quick-start)  
26. [Troubleshooting](#troubleshooting)  
27. [Future Capabilities](#future-capabilities)  
...
│   │   │   ├── router.py       # Main router with call_llm(), _select_provider_for_job_type(), _check_attachment_safety()
│   │   │   ├── job_classifier.py  # Automatic job classification (v0.12.7), video deep-analysis (v0.12.8)
...
**Location:** `app/llm/job_classifier.py` (NEW in v0.12.7, enhanced v0.12.8)

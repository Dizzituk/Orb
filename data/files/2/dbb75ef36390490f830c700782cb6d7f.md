...
| `CROSS_MODEL_REVIEW` | Google | `gemini-3.0-pro-preview` | Cross-model critique/review |
...
```bash
# Gemini critic model (must be gemini-3.0-pro-preview or better)
# Updated v0.13.4: Requires -preview suffix for Gemini 3 Pro
GEMINI_OPUS_CRITIC_MODEL=gemini-3.0-pro-preview
...
**Gemini 3 Pro Notes:**
- Model ID: `gemini-3.0-pro-preview` (requires -preview suffix)
...
2. Check model name is `gemini-3.0-pro-preview` (requires -preview suffix)
...
2. Check model name is valid:
   ...
   # Should be: gemini-2.5-pro (NOT gemini-1.5-pro or gemini-3.0-pro-preview)
   ```
...
- `GEMINI_OPUS_CRITIC_MODEL=gemini-3.0-pro-preview` (Gemini critic model)
...
- [ ] Model: `gemini-3.0-pro-preview` (requires -preview suffix)

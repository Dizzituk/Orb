...
actions:
  - name: StartGame
    ...
    stateChanges:
      ...
      - currentPiece: Generate random tetromino at spawn position
  ...
  - name: LockPiece
    ...
    stateChanges:
      ...
      - currentPiece: Set to nextPiece at spawn position
      - nextPiece: Generate new random tetromino
      - Triggers CheckLines action
      - Triggers CheckGameOver action

  - name: CheckLines
    description: Check for and clear completed horizontal lines, update score
    stateChanges:
      - board: Remove completed lines, shift above lines down
      - linesCleared: Add number of lines cleared
      - score: Add points based on lines cleared (100/300/500/800 for 1/2/3/4 lines)

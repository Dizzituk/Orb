# FILE: app/translation/_tier0_filesystem_query.py
# Purpose: Tier 0 filesystem-query classifier (list/read/find file ops with path or known-folder context).
...
"""
Tier 0 filesystem-query classifier.

Split out of _tier0_filesystem.py (BATCH 4) verbatim. One of four independent
Tier-0 classifiers; this one detects filesystem listing/read/search queries.
"""

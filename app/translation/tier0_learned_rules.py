...
Generated: 2026-03-08T21:06:14.968958Z
Candidates graduated: 3
"""
...
GRADUATED_RULES = [
    ('run critical pipeline', 'RUN_CRITICAL_PIPELINE_FOR_JOB', 95, 0.9794),  # id=6
    ('send to spec gate', 'SEND_TO_SPEC_GATE', 118, 0.9833),  # id=5
    ('astra command how does that look all together', 'WEAVER_BUILD_SPEC', 144, 0.9863),  # id=4
]

...
Generated: 2026-03-04T09:35:22.312021Z
...
GRADUATED_RULES = [
    ('run critical pipeline', 'RUN_CRITICAL_PIPELINE_FOR_JOB', 51, 0.9623),  # id=6
    ('send to spec gate', 'SEND_TO_SPEC_GATE', 68, 0.9714),  # id=5
    ('astra command how does that look all together', 'WEAVER_BUILD_SPEC', 91, 0.9785),  # id=4
]

...
Generated: 2026-03-09T21:06:01.542431Z
...
GRADUATED_RULES = [
    ('run critical pipeline', 'RUN_CRITICAL_PIPELINE_FOR_JOB', 96, 0.9796),  # id=6
    ('send to spec gate', 'SEND_TO_SPEC_GATE', 121, 0.9837),  # id=5
    ('astra command how does that look all together', 'WEAVER_BUILD_SPEC', 147, 0.9866),  # id=4
]

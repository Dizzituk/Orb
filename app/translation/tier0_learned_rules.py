...
Generated: 2026-03-02T10:25:36.557935Z
Candidates graduated: 2
"""
...
GRADUATED_RULES = [
    ('send to spec gate', 'SEND_TO_SPEC_GATE', 47, 0.9592),  # id=5
    ('astra command how does that look all together', 'WEAVER_BUILD_SPEC', 67, 0.971),  # id=4
]

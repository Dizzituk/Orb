...
from app.pot_spec.grounded._sandbox_discovery_utils_8 import OutputMode, SANDBOX_DISCOVERY_BUILD_ID, SYSTEM_SCAN_ROOTS, extract_create_targets, extract_replacement_text, is_multi_target_request
from app.pot_spec.grounded._sandbox_discovery_utils_9 import SYSTEM_SCAN_INDICATORS, detect_output_mode, get_system_scan_targets
from app.pot_spec.grounded._sandbox_discovery_utils_10 import extract_scan_file_names, is_system_wide_scan_request
from app.pot_spec.grounded._sandbox_discovery_utils_11 import FILENAME_STOPWORDS, extract_file_targets

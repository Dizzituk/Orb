# Purpose: evidence gathering utils 10
# Called-by: app.pot_spec.grounded.evidence_gathering
# Depends-on: app.pot_spec.grounded._evidence_gathering_utils_8, app.pot_spec.grounded._evidence_gathering_utils_9, app.pot_spec.grounded.evidence_gathering
# Last-renovated: 2026-06-11
from __future__ import annotations
import logging
import os
from app.pot_spec.grounded._evidence_gathering_utils_8 import EVIDENCE_ALLOWED_ROOTS, EVIDENCE_FORBIDDEN_PATHS, _resolve_via_index_json
from app.pot_spec.grounded._evidence_gathering_utils_9 import ANCHOR_RESOLUTION_MAP, COMMON_FILE_EXTENSIONS, extract_path_references

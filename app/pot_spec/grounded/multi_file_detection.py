...
from app.pot_spec.grounded._multi_file_detection_utils import MULTI_FILE_SCOPE_INDICATORS, STOPWORDS, UNICODE_QUOTES, _SCOPE_PATTERNS, _build_multi_file_operation, _convert_discovery_to_raw_matches, _detect_multi_file_intent, _has_multi_file_scope

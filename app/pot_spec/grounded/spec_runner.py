...
from app.pot_spec.grounded._spec_runner_utils_10 import SPEC_RUNNER_BUILD_ID, _ARCH_INDEX_DIR, _ARCH_REPORT_DIR, _FALLBACK_ALL_PATHS, _FALLBACK_BACKEND_PATHS, _FALLBACK_FRONTEND_PATHS, _PRODUCT_SYNONYMS_RAW, _build_simple_spec
from app.pot_spec.grounded._spec_runner_utils_11 import SCOPE_BACKEND, SCOPE_FRONTEND, _PRODUCT_SYNONYMS, _detect_search_replace_terms, _extract_requirements_from_spec, _generate_aliases_for_root, _get_job_dir_for_segmentation, _parse_product_synonyms
from app.pot_spec.grounded._spec_runner_utils_12 import _build_single_segment_manifest, _dedup_evidence_requests, _extract_project_paths, _write_segmentation_output
from app.pot_spec.grounded._spec_runner_utils_13 import _discover_project_roots, _extract_acceptance_from_spec, _extract_file_scope_from_spec

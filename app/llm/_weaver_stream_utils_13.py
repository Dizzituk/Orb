# Purpose: weaver stream utils 13
# Called-by: app.llm._weaver_stream_prepare, app.llm._weaver_stream_utils_14, app.llm._weaver_stream_utils_15, app.llm._weaver_stream_utils_17
# Depends-on: app.llm._weaver_stream_utils_14

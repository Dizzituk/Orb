...
def _build_db_archmap_prompt(files: List[Dict], zone_counts: Dict[str, int]) -> str:
    ...
    lines.extend([
        ...
        "",
        "### 5. File Size Report",
        "- List ALL files over 20KB with their sizes",
        "- Classify as: 🟡 AMBER (20-30KB) or 🔴 RED (>30KB)",
        "- No editorial — just the facts",
        "",
        "### 6. Architectural Strengths",
        "- Recognise production-grade patterns (multi-tier routing, spec gates, evidence-based dev, sandbox isolation)",
        "- Acknowledge the deliberate modular decomposition as an intentional design choice",
        "",
        "### 7. Observations",
        "- Only genuinely actionable findings: dead code, circular imports, security gaps, inconsistent naming",
        "- Do NOT flag: modular file decomposition, directory depth, file count, or layered subsystems",
        "",

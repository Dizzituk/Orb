# Purpose: codebase report utils 2
# Called-by: app.llm.local_tools.zobie.streams._codebase_report_utils_3, app.llm.local_tools.zobie.streams._codebase_report_utils_4, app.llm.local_tools.zobie.streams.codebase_report
# Depends-on: app.llm.local_tools.zobie.streams.codebase_report

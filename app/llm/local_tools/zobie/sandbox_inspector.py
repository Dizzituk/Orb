...
from app.llm.local_tools.zobie._sandbox_inspector_utils_4 import D_DRIVE_ROOT, MAX_CANDIDATE_FILES, MAX_CLASSIFICATION_CHARS, MAX_FILE_CHARS, MAX_SEARCH_DEPTH, SANDBOX_DESKTOP_ROOTS, _read_snippet, file_exists_in_sandbox
from app.llm.local_tools.zobie._sandbox_inspector_utils_5 import HOST_DESKTOP_ROOTS, HOST_DOCUMENTS_ROOTS, SANDBOX_DOCUMENTS_ROOTS, _bounded_folder_search, _discover_folder_without_hint, _select_file_from_folder, read_sandbox_file

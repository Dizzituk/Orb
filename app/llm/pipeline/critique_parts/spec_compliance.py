...
from app.llm.pipeline.critique_parts._spec_compliance_utils import _DESKTOP_DEFINITIVE_STACKS, _EXCLUSION_SECTION_HEADERS, _INLINE_EXCLUSION_PATTERNS, _MOBILE_DEFINITIVE_STACKS, _SCOPE_INFLATION_KEYWORDS, _SECTION_HEADER_RE, _STACK_KEYWORDS, _WORD_BOUNDARY_KEYWORDS

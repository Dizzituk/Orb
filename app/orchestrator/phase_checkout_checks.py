...
from app.orchestrator._phase_checkout_checks_utils import _KNOWN_PREEXISTING_FAILURES, _SILENT_IMPORT_PATTERNS, _build_fix_prompt, _discover_sandbox_base, _file_exists_in_sandbox, _find_largest_function, _try_deterministic_import_fix, map_file_to_segment
    MAX_FILE_KB,
    MAX_FILE_LINES,
    MAX_FUNCTION_LINES,
)

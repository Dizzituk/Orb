...
from app.orchestrator._cohesion_check_utils_8 import COHESION_CHECK_BUILD_ID, _build_cohesion_prompt, _classify_fix_tier, _extract_arch_file_paths, _extract_import_replacements, _extract_segment_references, _inject_logging_import, _save_patched_architecture
from app.orchestrator._cohesion_check_utils_9 import _apply_tier1_fix, _apply_tier2_fix, _parse_cohesion_response, load_cohesion_result, save_cohesion_result
from app.orchestrator._cohesion_check_utils_10 import CohesionIssue, CohesionResult, load_segment_architectures, run_cohesion_check

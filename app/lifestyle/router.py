...
def get_dashboard(db: Session = Depends(get_db)):
    ...
    from app.lifestyle.target_overrides import apply_target_overrides
    return apply_target_overrides(db, service.get_dashboard_summary(db))
...
def get_dashboard_day(
    ...
    from app.lifestyle.target_overrides import apply_target_overrides
    return apply_target_overrides(db, daily_view.get_day_dashboard(db, d))
...
def set_goal(goal: GoalIn, db: Session = Depends(get_db)):
    ...
    from app.lifestyle.target_overrides import set_goal_override    return set_goal_override(db, goal.goal_type, goal.target_value, goal.unit, goal.notes)

...
v2.0: Added confidence system with:
- PreferenceRecord: User preferences with confidence tracking
- PreferenceEvidence: Append-only evidence ledger
- HotIndex: Fast retrieval layer
- SummaryPyramid: Multi-level artifact summaries
- MemoryRecordConfidence: Confidence for non-preference records
"""
...
# =============================================================================
# GLOBAL PREFERENCES (Cross-Job) - LEGACY
# =============================================================================
...
class GlobalPref(Base):
    ...
    DEPRECATED: Use PreferenceRecord from preference_models.py instead.

...
from app.pipeline_v2.checks._deterministic_checker_utils_4 import DETERMINISTIC_CHECKER_BUILD_ID, DetCheckIssue, DetCheckResult, _unparse_safe, extract_expected_exports_from_arch, extract_required_exports, extract_segment_interface, format_segment_interfaces
from app.pipeline_v2.checks._deterministic_checker_utils_5 import deterministic_check
